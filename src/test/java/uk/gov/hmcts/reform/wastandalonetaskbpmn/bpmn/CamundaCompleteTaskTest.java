...
class CamundaCompleteTaskTest extends CamundaProcessEngineBaseUnitTest {

    @Test
    @Deployment(resources = {"wa-task-initiation-ia-asylum.bpmn"})
    void should_create_a_task_with_delay_until_and_complete_the_task() {
    ...
    @Test
    @Deployment(resources = {"wa-task-initiation-ia-asylum.bpmn"})
    void should_create_a_task_with_no_delay_until_and_complete_the_task() {
